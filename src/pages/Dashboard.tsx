...
type TabType = 'overview' | 'cash' | 'bank' | 'creditCard' | 'loan' | 'reports' | 'advancedReports' | 'categoryReport' | 'budget' | 'savings' | 'investments' | 'wallets' | 'activity' | 'security' | 'calculator' | 'export' | 'profile' | 'settings' | 'cleanup' | 'debug'
